    ...
    return (
        <div className="bg-slate-100 w-full h-auto flex flex-col p-4 border border-digital-blue-100 shadow-sm rounded-md">
            <div className='flex items-center'>
                <BookMarked />
                <h5 className='flex-1 ml-2 text-lg font-bold'>Spoon-Knife</h5>
            ...
            <div className='flex justify-around'>
                <p className='flex items-center gap-1'><FileBraces size={20}/> JavaScript</p>
                <p className='flex items-center gap-1'><Star size={20}/>1.6k</p>
                <p className='flex items-center gap-1'><GitFork size={20}/>300</p>
            </div>
        </div>
    );
};
