...
const AboutHero = () => {
    return (
        <section className='text-center h-[100vh] grid grid-cols-1 sm:grid-cols-2 p-10 gap-6 items-center justify-center bg-linear-to-l from-digital-blue-500/40 to-transparent'>
            ...
            <img src={heroImg} className='shadow-lg rounded-md h-130 w-auto border border-digital-blue-500 shadow-digital-blue-500 mx-auto'/>
        </section>
    )
}
