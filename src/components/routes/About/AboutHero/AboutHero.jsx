...
const AboutHero = () => {
    return (
        <section className='text-center min-h-screen grid grid-cols-1 sm:grid-cols-2 p-10 sm:p-20 gap-2 items-center justify-center bg-linear-to-l from-digital-blue-500/40 to-transparent'>
            <div className='flex flex-col gap-8 items-start justify-center'>
                <h2 className='text-5xl font-bold leading-normal text-white text-start'>Find any Github user in<span className='text-digital-blue-500'> seconds.</span></h2>
